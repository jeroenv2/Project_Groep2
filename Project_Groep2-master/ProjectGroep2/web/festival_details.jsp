...
<<<<<<< HEAD
<<<<<<< HEAD
                            <p class="open menu">Groepen</hp>
=======
                            <p class="open menu">Groepen</p>
>>>>>>> adc5b5f3b44c88bfdf133c64bd38e2fb65313b6f
=======
                            <h2 class="open menu">Groepen</h2>
>>>>>>> parent of adc5b5f... details fouten weergaven
                            <ul>
                                <% if (rsBandPFest.next()) {
                                do { %>
                                <li><form action="groep_details.jsp" method="post">
...
<<<<<<< HEAD
<<<<<<< HEAD
>>>>>>> bf4383018c246f3336f1273256994d8456e1edec
</html>
=======
    <%} catch (Exception e) {%>
    ...
    <body>
        <div id="pagina_omslag">
            ...
            <div id="inhoud_omslag">
                <section id="inhoud">
                    <div align="center">    
                        <p align="center"> Er is een fout gebeurd.</p>
